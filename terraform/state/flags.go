...
var Flags = []cli.Flag{
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_TYPE")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_NAME")),
	...
	&cli.BoolFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_STRICT")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_GITLAB_HTTP_HTTP_ADDRESS")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_GITLAB_HTTP_HTTP_LOCK_ADDRESS")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_GITLAB_HTTP_HTTP_LOCK_METHOD")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_GITLAB_HTTP_HTTP_UNLOCK_ADDRESS")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_GITLAB_HTTP_HTTP_UNLOCK_METHOD")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_GITLAB_HTTP_HTTP_USERNAME")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("TERRAFORM_STATE_GITLAB_HTTP_HTTP_RETRY_WAIT_MIN")),
		Required:    false,
		Value:       "5",
