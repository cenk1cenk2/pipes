...
| `$TF_PLAN_RETRY_TRIES` | Number of retries for terraform plan command. | `uint` | `false` | `5` |
| `$TF_PLAN_RETRY_DELAY` | Delay between retries for terraform plan command. | `duration` | `false` | `1m0s` |
