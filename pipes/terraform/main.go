...
import (
	...
	"gitlab.kilic.dev/devops/pipes/pipes/terraform/apply"
	"gitlab.kilic.dev/devops/pipes/pipes/terraform/install"
	"gitlab.kilic.dev/devops/pipes/pipes/terraform/lint"
	"gitlab.kilic.dev/devops/pipes/pipes/terraform/login"
	"gitlab.kilic.dev/devops/pipes/pipes/terraform/plan"
	"gitlab.kilic.dev/devops/pipes/pipes/terraform/publish"
