...
import (
	...
	"gitlab.kilic.dev/devops/pipes/pipes/go/build"
	"gitlab.kilic.dev/devops/pipes/pipes/go/install"
	"gitlab.kilic.dev/devops/pipes/pipes/go/lint"
	"gitlab.kilic.dev/devops/pipes/pipes/go/setup"
	"gitlab.kilic.dev/devops/pipes/pipes/go/tool"
