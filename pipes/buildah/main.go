...
import (
	...
	"gitlab.kilic.dev/devops/pipes/pipes/buildah/build"
	"gitlab.kilic.dev/devops/pipes/pipes/buildah/login"
	"gitlab.kilic.dev/devops/pipes/pipes/buildah/manifest"
	"gitlab.kilic.dev/devops/pipes/pipes/buildah/setup"
