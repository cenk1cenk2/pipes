...
var Flags = []cli.Flag{
	...
	&cli.StringSliceFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_MANIFEST_FILES")),
	...
	&cli.StringFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_MANIFEST_TARGET")),
	...
	&cli.StringSliceFlag{
		...
		Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_MANIFEST_IMAGES")),
	...
	&cli.StringFlag{
		...
		Sources:          cli.NewValueSourceChain(cli.EnvVar("BUILDAH_MANIFEST_MATRIX")),
