...
var Flags = CombineFlags(
	...
	[]cli.Flag{
		...
		&cli.StringSliceFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_PLATFORMS")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_NAME")),
		...
		&cli.StringSliceFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_TAGS")),
		...
		flags.YAMLFlag(&cli.StringFlag{
			...
			Sources:  cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_TAGS_TEMPLATE")),
    ...
    `),
		...
		flags.YAMLFlag(&cli.StringFlag{
			...
			Sources:  cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_TAGS_SANITIZE")),
			Usage: strings.TrimSpace(`
    ...
    `),
		...
		flags.YAMLFlag(&cli.StringFlag{
			...
			Sources:  cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_TAG_AS_LATEST")),
			Usage: strings.TrimSpace(`
    ...
    `),
		...
		&cli.BoolFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_PULL")),
		...
		&cli.BoolFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_PUSH")),
		...
		flags.YAMLFlag(&cli.StringFlag{
			...
			Sources:  cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_BUILD_ARGS")),
			Usage: strings.TrimSpace(`
    ...
    `),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_LATEST_TAG")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_CACHE")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_FORMAT")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_IMAGE_STORAGE_DRIVER")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_FILE_CONTEXT")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_FILE_NAME")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_MANIFEST_TARGET")),
		...
		&cli.StringFlag{
			...
			Sources:     cli.NewValueSourceChain(cli.EnvVar("BUILDAH_BUILD_MANIFEST_FILE")),
